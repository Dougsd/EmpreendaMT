...
var actionCodeSettings = {
    url: 'http://localhost:8080/application/cadastrar_mentor.html',
...
var actionCodeSettings = {
    url: 'http://localhost:8080/application/cadastrar_triagem.html',
    handleCodeInApp: true
};
...
pop_up.addEventListener("click", (e) => {
    var d = document.getElementById('pop-up').style.display = 'none';    
    e.preventDefault();
})